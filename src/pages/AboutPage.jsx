...
const AboutPage = () => {
  return (
    <div className="container article-page" style={{ maxWidth: "760px" }}>
      {" "}
      {/* 記事ページ風スタイル適用 */}
      ...
      <article className="article-content">
        ...
        <ul>
          ...
          <li>数学を通して論理的思考力を養うヒントの提供</li>
        </ul>
        <p>
          このサイトが、皆さんの知的好奇心を刺激し、数学の新たな魅力に気づくきっかけとなれば幸いです。
          ご意見やご感想、取り上げてほしいトピックなどがありましたら、お気軽にお寄せください。
        </p>
        {/* 連絡先情報やフォームへのリンクなどを追加しても良い */}
      </article>
    </div>
  );
};
